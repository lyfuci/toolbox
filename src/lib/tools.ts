...
export const tools: Tool[] = [
  ...
  { slug: 'json-to-ts', path: '/json-to-ts', icon: FileJson, category: 'format' },
  ...
  { slug: 'escape', path: '/escape', icon: Quote, category: 'encode' },
  { slug: 'unicode', path: '/unicode', icon: Type, category: 'encode' },
  ...
  { slug: 'cron', path: '/cron', icon: CalendarClock, category: 'convert' },
  ...
  { slug: 'chmod', path: '/chmod', icon: FileLock, category: 'convert' },
  { slug: 'dotenv', path: '/dotenv', icon: FileKey2, category: 'convert' },
  { slug: 'http-status', path: '/http-status', icon: ServerCog, category: 'network' },
  ...
  { slug: 'text-stats', path: '/text-stats', icon: BarChart3, category: 'text' },
  { slug: 'slugify', path: '/slugify', icon: Link, category: 'text' },
  { slug: 'markdown', path: '/markdown', icon: FileText, category: 'text' },
  { slug: 'translate', path: '/translate', icon: Languages, category: 'text' },
  ...
  { slug: 'images-to-pdf', path: '/images-to-pdf', icon: FileOutput, category: 'file' },
